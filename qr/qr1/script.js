...
function init() {
  ...
  add.addEventListener('click', () => {
    content.insertBefore(createQR('https://github.com/gjmaxg3960/www/blob/master/README.md?c#1'), add)
  });
  ...
  let localQr = JSON.parse(localStorage.getItem('_local_qr_codes_') || '["https://github.com/gjmaxg3960/www/blob/master/README.md?c#1"]');
